    ...
    sections: [
      ...
      // ── TOC ──
      {
        ...
        children: [
          ...
          // ── 9. ビジネスロジック ──
          h1("9. ビジネスロジック"),
          h2("9.1 有給休暇管理（就業規則 第59条準拠）"),
          p("**ファイル:** packages/shared/src/services/leave.service.ts"),
          spacer(),
          h3("付与日数テーブル（第59条第1項）"),
          makeTable(
            ["勤続年数", "入社時", "６ヶ月", "1年", "2年", "3年", "4年", "5年", "6年以上"],
            [
              ["付与日数", {text:"2日",center:true}, {text:"8日",center:true}, {text:"11日",center:true}, {text:"12日",center:true}, {text:"14日",center:true}, {text:"16日",center:true}, {text:"18日",center:true}, {text:"20日",center:true}],
            ],
            [1200, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 826]
          ),
          spacer(),
          h3("基準日・付与日（第59条第2項・第3項）"),
          makeTable(
            ["入社時期", "基準日", "付与日"],
            [
              ["1月1日〜6月30日入社", "6月30日", {text:"7月1日",bold:true}],
              ["7月1日〜12月31日入社", "12月31日", {text:"1月1日",bold:true}],
            ],
            [3500, 2700, 2826]
          ),
          spacer(),
          ...
          makeTable(
            ["スケジュール", "ジョブ名", "処理内容"],
            [
              ["毎日 00:05", "有給自動付与", "基準日方式（7/1・1/1）で有給付与 + 入社時2日付与"],
