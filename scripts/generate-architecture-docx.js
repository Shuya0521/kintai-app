    ...
    sections: [
      ...
      // ── TOC ──
      {
        ...
        children: [
          ...
          spacer(),
          p("**管理画面アクセス（ADMIN_ROLES）:** システム管理者・取締役・統括部長のみ"),
          p("**承認・Excel出力（APPROVER/EXPORT_ROLES）:** 上記 + 部長"),
          ...
          makeTable(
            ...
            [
              ...
              ["鈴木 英俊", "suzuki@company.example.com", "部長", "工事部", "承認+Excel出力"],
              ["河田 匡広", "kawata@company.example.com", "部長", "管理部", "承認+Excel出力"],
          ...
          ...codeBlock([
            ...
            "鈴木（部長）            -> 従業員ポータル + 承認権限 + Excel出力",
            "河田（部長）            -> 従業員ポータル + 承認権限 + Excel出力",
            "串間（課長）            -> 従業員ポータルのみ",
            "笠間（リーダー）         -> 従業員ポータルのみ",
          ]),
          new Paragraph({ children: [new PageBreak()] }),
