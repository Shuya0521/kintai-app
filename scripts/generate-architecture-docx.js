      ...
      // ── TOC ──
      {
        ...
        children: [
          ...
          makeTable(
            ...
            [
              ["打刻（自分）",     {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}],
              ["休暇申請",        {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}],
              ["管理画面アクセス", {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"×",center:true}],
              ["承認権限",        {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}],
              ["社員管理",        {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}],
              ["システム設定",    {text:"○",center:true}, {text:"○",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}, {text:"×",center:true}],
              ["Excel出力",      {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"○",center:true}, {text:"×",center:true}],
            ],
            [1400, 850, 850, 850, 850, 850, 850, 850, 850, 826]
          ),
          spacer(),
          h2("6.3 JWT トークン仕様"),
          makeTable(
          ...
          makeTable(
            ["名前", "メールアドレス", "役職", "部署", "権限"],
            [
              ["河村 佳徳", "kawamura@company.example.com", "取締役", "管理部", "管理者（作成者）"],
              ["鈴木 英俊", "suzuki@company.example.com", "部長", "工事部", "管理者・承認者"],
              ["河田 匡広", "kawata@company.example.com", "部長", "管理部", "管理者・承認者"],
              ["串間 絵理", "kushima@company.example.com", "課長", "管理部", "管理者"],
          ...
          ...codeBlock([
            ...
            "鈴木（部長）          -> 従業員 + 管理者ポータル（承認・勤怠管理）",
            "河田（部長）          -> 従業員 + 管理者ポータル（承認・勤怠管理）",
            "串間（課長）          -> 従業員 + 管理者ポータル（閲覧・限定管理）",
            "笠間（リーダー）       -> 従業員ポータルのみ",
