...
function tocEntry(chapter: string, title: string, page: string): Paragraph {
  return new Paragraph({
    spacing: { after: 80, line: 360 },
    children: [
      new TextRun({
...
async function generateManual() {
    ...
    sections: [
      ...
      // ════════════════════════════════════════
      {
        ...
        children: [
          ...
          emptyParagraph(),
          tocEntry("第1章", "はじめに", "2"),
          tocEntry("第2章", "ログイン方法", "4"),
          tocEntry("第3章", "ダッシュボード", "6"),
          tocEntry("第4章", "休暇申請の承認", "8"),
          tocEntry("第5章", "勤怠一覧とExcel出力", "11"),
          tocEntry("第6章", "メンバー管理", "13"),
          tocEntry("第7章", "残業レポートの確認", "16"),
          tocEntry("第8章", "マスタ管理", "18"),
          tocEntry("第9章", "システム設定", "20"),
          tocEntry("第10章", "よくある質問（FAQ）", "23"),
          tocEntry("第11章", "お問い合わせ先", "26"),
          ...
          bodyText(
            "本マニュアルは、勤怠管理システム「KINTAI」を管理者としてお使いいただくための操作説明書です。日々の承認業務やメンバー管理など、管理者が行うすべての操作について、手順を一つひとつ丁寧に説明しています。"
          ),
          bodyText(
          ...
          heading2("1.2　システム概要"),
          bodyText(
            "KINTAIは、株式会社サン・カミヤ専用の勤怠管理システムです。以下の2つのアプリケーションで構成されています。"
          ),
          emptyParagraph(),
          ...
          numberedStep(
            "①",
            "Webブラウザ（Google ChromeやSafari）を開きます。"
          ),
          numberedStep(
            "②",
          ...
          emptyParagraph(),
          numberedStep("①", "ログイン後、画面右上のアカウントアイコンをクリックします。"),
          ...
          emptyParagraph(),
          boldBodyText("■ 本日の出勤状況"),
          bodyText(
            "本日の全社員の出勤・欠勤状況が数値で表示されます。「出勤中」「未出勤」「休暇」などの人数を確認できます。"
          ),
          emptyParagraph(),
          boldBodyText("■ 未処理の申請"),
          bodyText(
            "承認待ちの休暇申請や打刻修正申請の件数が表示されます。数字が表示されている場合は、早めに承認・却下の処理を行ってください。"
          ),
          emptyParagraph(),
          boldBodyText("■ 残業警告"),
          bodyText(
            "36協定の基準を超える、またはそれに近い残業時間の社員がいる場合に警告が表示されます。赤色の表示は、早急な対応が必要です。"
          ),
          emptyParagraph(),
          boldBodyText("■ 今月の勤怠サマリー"),
          bodyText(
            "今月の全社的な勤怠状況（平均残業時間、有給取得率など）の概要が表示されます。"
          ),
          emptyParagraph(),
          ...
          emptyParagraph(),
          cautionBlock(
            "「未処理の申請」に件数が表示されている場合は、社員の業務に影響しますので、できるだけ早く処理してください。"
          ),
          ...
          bodyText(
            "承認管理画面には、画面上部にタブが表示されています。"
          ),
          emptyParagraph(),
          bulletItem("【未処理】タブ：まだ承認・却下していない申請の一覧です"),
          bulletItem("【処理済み】タブ：すでに承認・却下した申請の履歴です"),
          emptyParagraph(),
          bodyText(
            "【未処理】タブをクリックすると、承認待ちの申請がカード形式で一覧表示されます。各カードには以下の情報が表示されます。"
          ),
          bulletItem("申請者の氏名"),
          ...
          emptyParagraph(),
          numberedStep("①", "【未処理】タブで、承認したい申請カードを確認します。"),
          ...
          numberedStep("⑤", "「承認しました」と表示されたら完了です。申請は【処理済み】タブに移動します。"),
          emptyParagraph(),
          ...
          emptyParagraph(),
          numberedStep("①", "【未処理】タブで、却下したい申請カードを確認します。"),
          ...
          emptyParagraph(),
          bodyText(
            "残日数はシステムが自動で管理していますので、承認前に申請者の有給残日数が十分かどうかを確認することをお勧めします。"
          ),
          emptyParagraph(),
          ...
          heading2("5.2　月の選択方法"),
          bodyText(
            "初期状態では当月のデータが表示されています。過去の月や特定の月のデータを確認したい場合は、以下の操作を行います。"
          ),
          emptyParagraph(),
          numberedStep("①", "画面上部の【月選択】欄を確認します。"),
          numberedStep("②", "【◀】ボタンで前月、【▶】ボタンで翌月に切り替えることができます。"),
          numberedStep("③", "月を選択すると、自動的にその月のデータが表示されます。"),
          emptyParagraph(),
          ...
          emptyParagraph(),
          numberedStep("①", "画面上部の【部署】ドロップダウンをクリックします。"),
          numberedStep("②", "表示される部署一覧から、確認したい部署を選択します。"),
          bodyText("　　選択できる部署: 営業部、工事部、リフォーム推進部、管理部"),
          numberedStep("③", "選択した部署の社員のみが一覧に表示されます。"),
          numberedStep("④", "全部署のデータに戻す場合は、【全部署】を選択します。"),
          emptyParagraph(),

          heading2("5.4　Excel出力の手順"),
          bodyText(
            "勤怠データをExcelファイルとして出力する手順は以下の通りです。"
          ),
          emptyParagraph(),
          numberedStep("①", "出力したい月を選択します（5.2の手順参照）。"),
          numberedStep("②", "必要に応じて、部署フィルターで対象を絞り込みます（5.3の手順参照）。"),
          numberedStep("③", "画面上部の【📥 Excel出力】ボタンをクリックします。"),
          numberedStep("④", "Excelファイルのダウンロードが開始されます。"),
          numberedStep("⑤", "ダウンロードが完了すると、パソコンのダウンロードフォルダにファイルが保存されます。"),
          emptyParagraph(),

          heading2("5.5　出力されるファイルの説明"),
          bodyTextRuns([
            new TextRun({
              text: "ファイル名: ",
              size: 22,
          ...
          numberedStep("①", "左側メニューの【メンバー管理】をクリックします。"),
          numberedStep("②", "メンバー管理画面が表示され、全社員の一覧が表示されます。"),
          emptyParagraph(),

          heading2("6.2　新規社員の承認手順"),
          bodyText(
          ...
          numberedStep("②", "該当する社員の行をクリックして、詳細情報を確認します。"),
          numberedStep("③", "氏名・メールアドレスなどの情報が正しいことを確認します。"),
          numberedStep("④", "【承認】ボタンをクリックします。"),
          ...
          heading2("7.2　画面の見方"),
          bodyText(
            "残業レポートには、社員ごとの月間残業時間が一覧で表示されます。残業時間に応じて、以下の色分けで警告が表示されます。"
          ),
          emptyParagraph(),
              ...
              new TableRow({
                children: [
                  ...
                  new TableCell({
                    width: { size: 25, type: WidthType.PERCENTAGE },
                    shading: { type: ShadingType.SOLID, color: "333333" },
                    children: [new Paragraph({ children: [new TextRun({ text: "警告色", size: 22, font: "游ゴシック", bold: true, color: "FFFFFF" })] })],
                  }),
                  new TableCell({
                    width: { size: 50, type: WidthType.PERCENTAGE },
                    shading: { type: ShadingType.SOLID, color: "333333" },
                    children: [new Paragraph({ children: [new TextRun({ text: "意味", size: 22, font: "游ゴシック", bold: true, color: "FFFFFF" })] })],
                  }),
                ],
              }),
              new TableRow({
                children: [
                  new TableCell({
                    ...
                    children: [new Paragraph({ children: [new TextRun({ text: "45時間超過", size: 22, font: "游ゴシック" })] })],
                  }),
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFF3E0" },
                    children: [new Paragraph({ children: [new TextRun({ text: "橙（オレンジ）", size: 22, font: "游ゴシック", color: "E65100" })] })],
                  }),
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFF3E0" },
                    children: [new Paragraph({ children: [new TextRun({ text: "36協定の基準を超過しています", size: 22, font: "游ゴシック" })] })],
                  }),
                ],
              }),
              new TableRow({
                children: [
                  new TableCell({
                    ...
                    children: [new Paragraph({ children: [new TextRun({ text: "80時間超過", size: 22, font: "游ゴシック" })] })],
                  }),
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFEBEE" },
                  ...
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFEBEE" },
                    children: [new Paragraph({ children: [new TextRun({ text: "医師の面接指導が必要です", size: 22, font: "游ゴシック" })] })],
                  }),
                ],
              }),
              new TableRow({
                children: [
                  new TableCell({
                    ...
                    children: [new Paragraph({ children: [new TextRun({ text: "100時間超過", size: 22, font: "游ゴシック" })] })],
                  }),
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFCDD2" },
                  ...
                  new TableCell({
                    shading: { type: ShadingType.SOLID, color: "FFCDD2" },
                    children: [new Paragraph({ children: [new TextRun({ text: "法定上限を超過しています（違法）", size: 22, font: "游ゴシック" })] })],
                  }),
                ],
              }),
            ],
          ...
          numberedStep("①", "マスタ管理画面で【部署管理】タブをクリックします。"),
          numberedStep("②", "現在登録されている部署の一覧が表示されます。"),
          numberedStep("③", "【部署を追加】ボタンをクリックします。"),
          numberedStep("④", "【部署名】欄に、追加したい部署の名前を入力します。"),
          ...
          emptyParagraph(),
          cautionBlock(
            "部署名を変更すると、その部署に所属する全社員の表示にも反映されます。変更は慎重に行ってください。"
          ),
          emptyParagraph(),

          heading2("8.3　祝日の設定"),
          heading3("8.3.1　祝日の追加"),
          numberedStep("①", "マスタ管理画面で【祝日管理】タブをクリックします。"),
          numberedStep("②", "現在登録されている祝日の一覧が表示されます。"),
          numberedStep("③", "【祝日を追加】ボタンをクリックします。"),
          numberedStep("④", "【日付】欄で、祝日の日付を選択します。"),
          numberedStep("⑤", "【祝日名】欄に、祝日の名前を入力します（例: 元日、成人の日）。"),
          numberedStep("⑥", "【保存】ボタンをクリックします。"),
          numberedStep("⑦", "一覧に新しい祝日が追加されたら完了です。"),
          emptyParagraph(),
          bodyText(
            "祝日として登録した日は、勤怠計算において休日として扱われます。年度初めに、その年の祝日をまとめて登録しておくことをお勧めします。"
          ),
          emptyParagraph(),

          heading3("8.3.2　祝日の削除"),
          numberedStep("①", "削除したい祝日の行にある【削除】ボタンをクリックします。"),
          numberedStep("②", "確認ダイアログで【OK】をクリックします。"),
          numberedStep("③", "祝日が一覧から削除されたら完了です。"),
          emptyParagraph(),
          ...
          ...chapterCapabilities([
            "会社の基本設定を変更できます",
            "勤務ルール（所定労働時間など）を調整できます",
            "承認設定や通知設定を確認・変更できます",
          ]),

          heading2("9.1　設定画面の開き方"),
          numberedStep("①", "左側メニューの【設定】をクリックします。"),
          numberedStep("②", "設定画面が表示されます。画面上部に4つのタブがあります。"),
          emptyParagraph(),
          bodyText("設定画面は、以下の4つのタブで構成されています。"),
          bulletItem("【基本設定】タブ"),
          bulletItem("【勤務ルール】タブ"),
          bulletItem("【承認設定】タブ"),
          bulletItem("【通知設定】タブ"),
          ...
          emptyParagraph(),
          numberedStep("①", "【基本設定】タブをクリックします。"),
          numberedStep("②", "以下の項目を確認・変更できます。"),
          emptyParagraph(),
          bulletItem("会社名: システムに表示される会社名です"),
          bulletItem("始業時刻: 標準の始業時刻を設定します（例: 09:00）"),
          bulletItem("終業時刻: 標準の終業時刻を設定します（例: 18:00）"),
          emptyParagraph(),
          ...
          emptyParagraph(),
          numberedStep("①", "【勤務ルール】タブをクリックします。"),
          numberedStep("②", "以下の項目を確認・変更できます。"),
          emptyParagraph(),
          bulletItem("所定労働時間: 1日の標準的な労働時間です（例: 8時間）"),
          bulletItem("残業閾値: この時間を超えると残業として扱われます"),
          emptyParagraph(),
          numberedStep("③", "変更した場合は、【保存】ボタンをクリックします。"),
          emptyParagraph(),
          cautionBlock(
            "勤務ルールの変更は、全社員の勤怠計算に影響します。変更前に、人事部門と十分にご相談ください。"
          ),
          emptyParagraph(),
          ...
          heading2("Q6. 部署を削除したいのですが、削除ボタンがありません。"),
          bodyText(
          ...
          numberedStep("①", "ブラウザの再読み込みボタン（🔄）をクリックするか、キーボードのF5キーを押します。"),
          ...
          bodyText(
            "はい、スマートフォンのブラウザからも管理画面にアクセスできます。第2章「ログイン方法」の2.4に記載されている手順で、iPhoneのホーム画面にアイコンを追加すると、より便利にお使いいただけます。"
          ),
          emptyParagraph(),
          ...
          heading2("11.2　お問い合わせの際にお伝えいただきたい情報"),
          bodyText(
          ...
          heading2("11.3　スクリーンショットの撮り方"),
          bodyText(
            "パソコンでスクリーンショットを撮る方法は以下の通りです。"
          ),
          emptyParagraph(),
  ...
  const outputPath = path.join(
    ...
    "勤怠ｱﾌﾟﾘ",
    "docs",
    "KINTAI_管理者マニュアル.docx"
  );

  const buffer = await Packer.toBuffer(doc);
  fs.writeFileSync(outputPath, buffer);
  console.log(`マニュアルを生成しました: ${outputPath}`);
}
